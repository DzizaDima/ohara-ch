...
;// CONCATENATED MODULE: ./src/javascripts/webcomponents/fake-testimonials-slider.js


class FakeTestimonialsSlider extends HTMLElement {
  constructor() {
    super();
  ...
  init() {
    const wrapper = this.closest('[data-fake-testimonials-slider-wrapper]');
    ...
    this.swiperInstance = new Swiper(this, {
      ...
      on: {
        init: () => wrapper?.classList.add('swiper-initialized'),
      },
      breakpoints: {
        768: {
          spaceBetween: 30,
...
if (!customElements.get('fake-testimonials-slider')) {
  customElements.define('fake-testimonials-slider', FakeTestimonialsSlider);
}
